...
/*f the user clicks the button 3 times, and 5 seconds is already elapsed since the page is loaded, a text should appear under the button:
...
button.addEventListener('click', madnessClick);

function madnessClick(event) {
  ...
  if (firstClickTime >= 5000) {
    ...
    button.removeEventListener('click', madnessClick);
  };
};